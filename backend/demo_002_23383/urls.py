"""demo_002_23383 URL Configuration
...
admin.site.site_header = "Demo-002"
admin.site.site_title = "Demo-002 Admin Portal"
admin.site.index_title = "Demo-002 Admin"

# swagger
api_info = openapi.Info(
    title="Demo-002 API",
    default_version="v1",
    description="API documentation for Demo-002 App",
)
